...
------------------------------------------------------
ArrayField - A community made Rayfield version. // Interface Design
Sirius - The original company that made Rayfield. // Features
...
function Hide()
	...
	Debounce = true
	RayfieldLibrary:Notify({Title = "Interface Hidden", Content = "The interface has been hidden, you can unhide the interface by tapping Q", Duration = 7})
...
function RayfieldLibrary:CreateWindow(Settings)
	...
	if Settings.LoadingTitle ~= "Arrayfield Interface Suite" then
		LoadingFrame.Version.Text = "Powered by Guardsman"
	end
		...
		function Tab:CreateKeybind(KeybindSettings)
			...
			UserInputService.InputBegan:Connect(function(input, processed)
				...
				if CheckingForKey then
					if input.KeyCode ~= Enum.KeyCode.Unknown and input.KeyCode ~= Enum.KeyCode.Q then
